...
class PygamePanel(wx.Panel):
	...
	def loadAudio(self, pathname):
		self.audio_path = pathname
	...
	def Update(self, evt):
		...
		if not self.rendering:
			...
			if self.listen.get_struck(pygame.K_1):
				self.objctrl.boil()
			if self.listen.get_struck(pygame.K_2):
				self.objctrl.scale()
